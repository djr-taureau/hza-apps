...
import { Component, OnInit, Directive, ViewEncapsulation, Input, HostBinding } from '@angular/core';
import { classWithModifiers } from '@hza/shared/utils';
@Component({
	selector: 'fs-value-callout',
	templateUrl: './value-callout.component.html',
	styleUrls: [
		'./value-callout.component.scss'
	],
	encapsulation: ViewEncapsulation.None
})
export class DashboardOverviewComponent implements OnInit {
	@Input() theme: string;
	elementName = 'fs-value-callout';
