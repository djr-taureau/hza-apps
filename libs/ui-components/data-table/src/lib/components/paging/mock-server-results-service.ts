...
import { ApiService } from '@hza/api';
import { ApiEndpointService } from '@hza/core';
/**
...
export class MockServerResultsService {
  ...
  public getResults(page: Page): Observable<PagedData<CorporateEmployee>> {
    return this.apiService.get<CorporateEmployee[]>('/company').pipe(map(d => this.getPagedData(page)));
  }
