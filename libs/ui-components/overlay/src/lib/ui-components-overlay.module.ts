...
const COMPONENTS = [OverlayComponent, YesNoComponent, SubscribeComponent, OpenFocusDirective, OpenModalDirective];

@NgModule({
	declarations: COMPONENTS,
	imports: [OverlayModule, ReactiveFormsModule, OverlayCoreModule, PopoverModule],
	exports: COMPONENTS,
