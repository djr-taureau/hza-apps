...
function requiredField(key: string, type = 'input', label: string = '', templateOptions = {}, otherOptions = {}) {
	return field(key, type, label, { ...templateOptions, required: true }, otherOptions);
}

function text(key: string, label: string, templateOptions = {}): FormlyFieldConfig {
...
function requiredNumber(
	...
	return number(key, label, { ...templateOptions, required: true }, otherOptions);
}

function requiredText(key: string, label: string, templatOptions = {}, otherOptions = {}): FormlyFieldConfig {
...
function checkbox(key: string, label: string, templateOptions = {}): FormlyFieldConfig {
	return field(key, 'checkbox', label, templateOptions);
}

function requiredCheckbox(key: string, label: string, templateOptions = {}): FormlyFieldConfig {
	return field(key, 'checkbox', label, templateOptions);
}
...
function requiredSelect(key: string, label: string = '', options: FormlyTemplateOptions = {}, otherOptions = {}) {
	return field(key, 'select', label, { options, required: true }, otherOptions);
}

function multiSelect(key: string, label: string = '', options: any[], templateOptions = {}) {
...
function radio(key: string, label: string = '', options: any[], templateOptions: FormlyTemplateOptions = {}) {
	return field(key, 'radio', label, { options, ...templateOptions });
}

function requiredRadio(key: string, label: string = '', options: any[], templateOptions: FormlyTemplateOptions = {}) {
...
function requiredDate(
	...
	return field(key, 'datepicker', label, { ...templateOptions, required: true }, otherOptions);
}
