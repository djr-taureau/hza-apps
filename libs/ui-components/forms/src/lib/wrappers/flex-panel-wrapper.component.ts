...
export class FlexPanelWrapperComponent extends FieldWrapper {
  @ViewChild('fieldComponent', {read: ViewContainerRef}) fieldComponent: ViewContainerRef;
  	to: FormlyTemplateOptions & { fxLayout: string; fxLayoutAlign: string, fxFlexLabel: string, fxFlexSpacer: string, fxFlexField: string, fxLayoutLabel: string, fxLayoutField: string };
    ...
    this.to.fxLayoutLabel = this.to.fxLayoutLabel || 'start';
    this.to.fxLayoutField = this.to.fxLayoutField || 'end';
	}
}
